...
- [Estado real vs. escrito](project_innoprospect_estado_real.md) — peças completas e testadas SEM chamador (assertions, sendText, warmup); correções pendentes ao ARQUITETURA.md.
